...
Thanks for considering a contribution to Synced Fluid.

Synced Fluid is an open-source fluid CSS design system maintained by SyncedCo.
...
- Avoid positioning Synced Fluid as a Tailwind copy or one-for-one replacement;
