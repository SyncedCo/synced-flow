...
Synced Fluid is not a one-for-one Tailwind replacement. The useful migration
...
Start with compatibility utilities generated by `synced-fluid build`, then move
repeated layout patterns to Synced Fluid primitives.

| Tailwind-style pattern | Synced Fluid direction |
| --- | --- |
